...
void Resources::load()
{
    ...
    button = texture->load("res/button.png");

    setting_button = texture->load("res/settingButton.png");

    pacman = texture->load("res/pacman.png");

    object = texture->load("res/object.png");

    labyrinth = texture->load("res/labyrinth.png");

    number = texture->load("res/number.png");

    //alphabet = texture->load("res/alphabet.png");

    score = texture->load("res/score.png");

    fruit = texture->load("res/fruits.png");

    unique_ghost = texture->load("res/uniqueGhost.png");

    speech = texture->load("res/speech.png");
