...
void Audio::load()
{
    ...
    ///Load Music
    game_start = sound->loadMusic("res/game_start.wav");

    intermission = sound->loadMusic("res/intermission.wav");

    ///Load Effect
    credit = sound->loadEffect("res/credit.wav");

    munch = sound->loadEffect("res/munch_1.wav");

    upgrade = sound->loadEffect("res/ghost_upgrade.wav");

    extend = sound->loadEffect("res/extend.wav");

    power_pellet = sound->loadEffect("res/power_pellet.wav");

    siren = sound->loadEffect("res/siren_1.wav");

    death = sound->loadEffect("res/death_1.wav");

    eat_ghost = sound->loadEffect("res/eat_ghost.wav");

    eat_fruit = sound->loadEffect("res/eat_fruit.wav");

    confused = sound->loadEffect("res/confused.wav");

    freeze = sound->loadEffect("res/freeze.wav");

    speed = sound->loadEffect("res/speed.wav");

    boss_show_up = sound->loadEffect("res/boss_show_up.wav");

    upgrade_mystery = sound->loadEffect("res/upgrade_mystery.wav");

    boss_death = sound->loadEffect("res/boss_death.wav");
